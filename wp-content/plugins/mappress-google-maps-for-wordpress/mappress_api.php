...
class Mappress_Api extends WP_REST_Controller {
	...
	public function get_maps($request) {
        ...
        foreach(array('filter', 'oid', 'otype', 'page', 'page_size', 'search', 'sort_by', 'sort_asc') as $arg)
            $$arg = (isset($args[$arg])) ? $args[$arg] : null;
			...
			array(
				array(
					...
					'args' => array(
						...
						'search' => array('sanitize_callback' => 'sanitize_title', 'default' => null),
